  ...
  */    
    ...
    public boolean sendMail(String title,String content,String type,String tomail) throws Exception{   
    	...
    	//这个类主要是设置邮件   
	     ...
	     mailInfo.setUserName("13333103979@163.com");    
	     mailInfo.setPassword("qq27689480");//您的邮箱密码    
	     mailInfo.setFromAddress("13333103979@163.com");    
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setPassword("qq27689480");//您的邮箱密码    
	     mailInfo.setFromAddress("13333103979@163.com");    
	     mailInfo.setToAddress("447125720@qq.com");    
